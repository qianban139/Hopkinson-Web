...
export const LITERATURE_CORPUS: LiteratureEntry[] = [
  ...
  /* ─────────── AI 驱动的 SHPB 性能预测 ─────────── */
  {
    id: 'long-2021-bp-shpb-concrete',
    title: '基于人工神经网络的混凝土类材料 SHPB 动态压缩性能预测',
    authors: ['龙旭', '毛明惠', '陆长恒', '苏天雄', '贾凤瑞'],
    year: 2021,
    venue: '南京航空航天大学学报, 53(5):789-800',
    doi: '10.16356/j.1005-2615.2021.05.017',
    abstract:
      '针对混凝土类脆性材料在高应变率下的本构行为，结合 ABAQUS 有限元仿真与 BP 人工神经网络，' +
      '分析 SHPB 实验中的关键波形参数，提出基于机器学习的混凝土类材料高应变率力学性能预测方法。' +
      '采用 ABAQUS 显式动力学模块，在入射杆自由端施加 4 种不同峰值 (60-160 MPa) 应力波，获得 ' +
      'Drucker-Prager 本构下混凝土 (20 组) 应力-应变曲线，以入射波为输入层、反射透射波为输出层训练 BP 网络。' +
      '结果表明：模型泛化能力良好，可替代重复有限元建模，准确预测 500-1400/s 应变率区间混凝土的应力应变响应，' +
      '并可外推至训练样本未覆盖的应变率范围。',
    keywords: ['SHPB', 'BP 神经网络', '混凝土', 'ABAQUS', 'Drucker-Prager', '本构预测', '高应变率', '人工神经网络'],
    category: 'constitutive-model',
    materials: ['concrete-01', 'concrete-02', 'concrete-03'],
  },
  {
    id: 'wang-2024-mcsn-coal-ct',
    title: '基于深度学习的煤岩 Micro-CT 裂隙智能提取与应用',
    authors: [
      '王登科', '方宇', '魏建平', '张宏图', '赵立桢',
      '王龙航', '夏元娣', '李璐', '王少普', '张强', '任海辉',
    ],
    year: 2024,
    venue: '煤炭学报, 49(8):3439-3452',
    doi: '10.13225/j.cnki.jccs.2023.0992',
    abstract:
      '针对煤岩 CT 扫描图像中矸石干扰、多尺度裂隙识别困难的问题，提出基于深度学习的煤岩裂隙提取网络 MCSN。' +
      '网络采用 U-Net 编码器-解码器结构与跳跃连接，编码器部分通过迁移学习引入 VGG16 预训练权重，' +
      '解码器部分引入深度可分离空洞卷积模块 (DCAC) 与残差模块，以增强 CT 图像裂隙特征提取能力。' +
      '使用煤工业 CT 扫描系统采集内部切片并人工标注，数据增广后形成 6000 张煤岩 CT 裂隙数据集 (训练 4200 / 验证 1800)。' +
      '与经典 CNN 和阈值分割对比，MCSN 在定性与定量指标上均显著领先，' +
      '并成功应用于巷道围岩钻孔窥视裂隙识别，为瓦斯抽采钻孔注封提供指导。',
    keywords: ['深度学习', 'Micro-CT', '煤岩', '裂隙提取', 'U-Net', 'VGG16 迁移学习', 'DCAC 空洞卷积', 'MCSN'],
    category: 'material-science',
    materials: ['rock-01', 'rock-02', 'rock-03'],
  },
];
